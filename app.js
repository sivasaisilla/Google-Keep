          ...
          <div class="toolbar-container">
            <div class="toolbar">
              <img class="toolbar-color" data-id=${
                note.id
              } src="https://img.icons8.com/?size=100&id=EG8w2uT1ilwj&format=png&color=000000">
              <img data-id=${
                note.id
              } class="toolbar-delete" src="https://img.icons8.com/?size=100&id=67884&format=png&color=000000">
            </div>
          </div>
        </div>
     `
